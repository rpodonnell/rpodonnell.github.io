...
[**O’Donnell RP**, Linde CC, May TW (2025) Rise up, *Rhizoctonia*: moving to one fungus, one name in the *Ceratobasidiaceae* (*Agaricomycetes*; *Cantharellales*). *Persoonia* 54, 285–325. doi:10.3114/persoonia.2025.54.09.](https://www.persoonia.org/images/Volume54/Persoonia54Art9.pdf)

[**O’Donnell RP**, Wong DJ, Peakall R, Phillips RD, Linde CC (2024) *Discordance Down Under*: Combining phylogenomics & fungal symbioses to detangle difficult nodes in a diverse tribe of Australian terrestrial orchids. *Systematic Biology* 74, 3:434–452. doi:10.1093/sysbio/syae070.](https://doi.org/10.1093/sysbio/syae070)
...
**O’Donnell RP**, Phillips RD, Peakall R, Linde CC (in review - Annals of Botany) It’s not easy being green: Population genomics and species boundaries in sexually deceptive greenhood orchids (*Pterostylis*; Cranichideae) 

John EG$^†$, **O’Donnell RP**$^†$, Perkins J, Rubial M, Peakall R, Wong DCJ (in review - Molecular Biology and Evolution) Once in a blue moon: phylotranscriptomics reveals the unusual genetic basis of blue floral colour in the terrestrial orchid subtribe Caladeniinae (Diurideae; Orchidaceae).

$^†$Shared co-first authors.

### Co-author

Hosna ACN, May TW, **O'Donnell RP**, Dearnaley JDW, Linde CC (in review - Mycologia) New species of *Serendipita* associated with Australian terrestrial orchids in the Diurideae.
